...
export default function DropdownFAQ({question, answer}) {
    ...
    return(
    <div onClick={() => setIsOpen(prev => !prev)} className='transation-all cursor-pointer w-full md:max-w-[550px] lg:max-w-[800px] px-8 py-4 background-card-gradient rounded-[14px] shadow-primary'>
